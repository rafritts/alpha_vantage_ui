...
<section class="space-y-6">
	...
	<div class="card bg-base-100 shadow">
		<div class="card-body">
			<form class="grid grid-cols-1 gap-3 md:grid-cols-2 lg:grid-cols-3" on:submit={onSubmit}>
				<label class="form-control">
					<div class="label">
						<span class="label-text font-semibold">Tickers (comma separated)</span>
					</div>
					<input class="input-bordered input" placeholder="e.g. AAPL,MSFT" bind:value={tickers} />
				</label>
				<label class="form-control">
					<div class="label">
