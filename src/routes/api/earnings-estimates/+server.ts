...
// GET /api/earnings-estimates?symbol=AAPL
export const GET: RequestHandler = async ({ url }) => {
  ...
  // EARNINGS_ESTIMATES returns EPS and revenue estimates with horizons
  const result = await callAlphaVantage('EARNINGS_ESTIMATES', { symbol });
